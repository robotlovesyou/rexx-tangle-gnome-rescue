class_name RifleTrap
extends Node2D


const CHARGING_ANIMATION_FRAMES = 18
...
func _fire_projectile() -> void:
	_firing_player.play()
	_next_projectile.fire(_projectile_direction() * projectile_speed)
