...
signal player_hit_ghost(PathFollowerGhost)
...
func gnome_poisoned_sync(gnome: Gnome) -> void:
	gnome_poisoned.emit(gnome)
	
func gnome_poisoned_async(gnome: Gnome) -> void:
	gnome_poisoned.emit.call_deferred(gnome)
	
func gnome_burned_sync(gnome: Gnome) -> void:
	gnome_burned.emit(gnome)
	
func gnome_burned_async(gnome: Gnome) -> void:
	gnome_burned.emit.call_deferred(gnome)
...
func player_hit_ghost_sync(ghost: PathFollowerGhost) -> void:
	player_hit_ghost.emit(ghost)
	
func player_hit_ghost_async(ghost: PathFollowerGhost) -> void:
	player_hit_ghost.emit.call_deferred(ghost)
